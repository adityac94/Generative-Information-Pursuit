"""
Concept network architecture from 'Concept Bottleneck Models' paper.
This pretrained network is finetuned on CUB to predict concepts or output labels.
Implementation borrowed from: https://github.com/yewsiang/ConceptBottleneck
"""
